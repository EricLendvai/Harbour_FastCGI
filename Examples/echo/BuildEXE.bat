...
rem if %HB_COMPILER% == msvc64 call "%ProgramFiles%\Microsoft Visual Studio\2022\Community\VC\Auxiliary\Build\vcvarsall.bat" x86_amd64
...
rem  cannot used -shared due to some libs. Still researching into this matter.
    hbmk2 %EXEName%_windows.hbp vscode_debugger.prg -b -p -w3 -dDEBUGVIEW -dCLIPBOARDSUPPORT
) else (
